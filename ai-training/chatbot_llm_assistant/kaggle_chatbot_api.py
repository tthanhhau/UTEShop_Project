# ============================================================
# UTEShop AI Chatbot - Kaggle API Server
# ============================================================
# HUONG DAN SU DUNG TREN KAGGLE:
#   1. Mo Kaggle -> Create Notebook
#   2. Notebook settings:
#      - Accelerator: GPU T4 x2 hoac P100/T4
#      - Internet: ON (bat buoc neu dung ngrok va pip install)
#   3. Add Input dataset co chua model:
#      - uteshop-ai-q4_k_m.gguf
#      hoac:
#      - uteshop-ai-model.zip co chua file .gguf
#   4. Copy toan bo code file nay vao 1 cell va Run
#   5. Copy link Ngrok, dan vao bien KAGGLE_AI_BASE_URL tren Render/backend
# ============================================================
