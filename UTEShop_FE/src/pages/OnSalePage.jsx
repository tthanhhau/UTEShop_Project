    ...
    return (
        <div className="max-w-7xl mx-auto p-4">
            ...
            <div className="text-center mb-12">
                <h1 className="text-4xl font-bold text-gray-800 mb-4">ON SALE</h1>
                <p className="text-gray-600 text-lg">Săn ngay những ưu đãi hấp dẫn nhất</p>
                <div className="w-24 h-1 bg-red-600 mx-auto mt-4"></div>
                {pagination.total && (
                    <p className="text-gray-500 mt-4">
                        Hiển thị {products.length} trong tổng số {pagination.total} sản phẩm giảm giá
                    </p>
                )}
            </div>
