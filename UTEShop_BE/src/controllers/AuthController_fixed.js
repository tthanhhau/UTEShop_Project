...
import { sendMail, testEmail } from '../config/mailer_fixed.js';
...
export const registerRequestOtp = asyncHandler(async (req, res) => {
    ...
    console.log('📧 Register OTP request for:', email);
...
export const registerVerify = asyncHandler(async (req, res) => {
    ...
    console.log('🔍 Register verify request for:', email);
...
export const resetVerify = asyncHandler(async (req, res) => {
    ...
    console.log('🔍 Reset verify request for:', email);
