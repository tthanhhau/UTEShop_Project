...
// Controllers (import tất cả các hàm cần thiết từ file controller đã sửa lỗi)
import {
    registerRequestOtp,
    registerVerify,
    resetRequestOtp,
    ...
    logout,
    testEmailEndpoint, // Thêm test email endpoint
} from "../controllers/AuthController_fixed.js";
...
if (process.env.NODE_ENV === 'development') {
    ...
    console.log('📧 Test email endpoint enabled at POST /api/auth/test-email');
}
